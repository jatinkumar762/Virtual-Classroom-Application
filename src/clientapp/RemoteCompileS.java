...
public class RemoteCompileS extends JPanel implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent ae)
    {
    	if(ae.getSource()==btnClose)
    	{
    		 ...
    		 if(JOptionPane.showConfirmDialog(ClientRes.swin.sSession,"Are you sure ?","Compiler",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION)
    		 {
    			 ClientRes.swin.jtb.remove(ClientRes.swin.rsCompile);
    		 }
    	}
    	if(ae.getSource()==btnSumbit)
    	{
    		 if(JOptionPane.showConfirmDialog(ClientRes.swin.sSession,"Are you sure ?","Sumbit",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION)
    		 {
    			 try
    			 {
